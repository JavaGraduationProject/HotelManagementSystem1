  ...
  export default {
      ...
      watch:{
        leaveDate: function () {
          ...
          if(this.roomType.discount){
            this.form.orderCost = (this.form.orderDays * (this.roomType.price * ((100-this.roomType.discount)/100))).toFixed(2)
          }else{
            this.form.orderCost = (this.form.orderDays * this.roomType.price).toFixed(2)
          }
        }
      },
      methods:{
