        ...
        <mu-row gutter>
          <mu-col xl="3" lg="4" md="6" sm="12" span="12"  v-for="rt in roomTypeList" :key="rt.typeId">
            <mu-card style=" margin: 10px auto;"  raised>
              ...
              <!--<mu-card-media>-->
                <img v-if="rt.typeId == 1" src="../assets/imgs/dachuang.jpg"/>
                <img v-else-if="rt.typeId == 2" src="../assets/imgs/shuang.jpg"/>
                <img v-else-if="rt.typeId == 3" src="../assets/imgs/tejia.jpg"/>
                <img v-else-if="rt.typeId == 4" src="../assets/imgs/haohua.jpg"/>
                <img v-else  src="../assets/imgs/room.jpg"/>
              </mu-card-media>
              ...
              <mu-card-text>
                <mu-list id="roomDetail">
                  <mu-list-item>
                    ...
                    <span v-if="rt.windows === 0">
                      <mu-icon left value="web_asset"></mu-icon>
                      是否有窗:没有
                    </span>
                    <span v-else-if="rt.windows === 1">
                      <mu-icon left value="web_asset"></mu-icon>
                      是否有窗:有
                    </span>
                  </mu-list-item>
