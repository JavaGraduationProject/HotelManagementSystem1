<template>
  <el-card class="box-card" shadow="always">
    <div slot="header">
      <span>部门信息管理</span>
      <el-input v-model="searchData" placeholder="请输入部门名称">
...
<script>
import { getAllDepartment, delDepartment } from '../../api/department'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getAllDepartment(this.searchData).then(response => {
