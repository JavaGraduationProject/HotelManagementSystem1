  ...
  <el-card class="app-container" shadow="always">
    ...
    <el-form ref="form1" :model="form1" :rules="rules2" label-width="120px">
      ...
      <el-form-item
        ...
        prop="departmentId"
      >
        <el-select v-model.number="form1.departmentId" placeholder="请选择部门">
          <el-option
      ...
      <el-form-item
        ...
        prop="roleId"
      >
        <el-select v-model.number="form1.roleId" placeholder="请选择角色">
          <el-option
...
import { getAllWorkRole } from '@/api/workRole'
...
export default {
  ...
  methods: {
    ...
    getAllWorkRole() {
      getAllWorkRole().then(res => {
        this.workRoleList = res.data
      })
    },
    fetchData() {
      ...
      getById(this.form1.workerId).then(res => {
        this.form1 = res.data
        this.form1.departmentId=res.data.department.id
        this.form1.roleId=res.data.workRole.id
      })
    },
    onSubmit() {
