<template>
  <el-card class="box-card" shadow="always">
    <div slot="header">
      <span>服务员管理</span>
      <el-input v-model="searchData" placeholder="请输入姓名">
    ...
    <div style="padding: 14px;">
      <div class="bottom">
        <el-button type="primary" @click="navigateTo('add')">添加服务员</el-button>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getAll(this.searchData, this.role).then(response => {
    ...
    navigateTo(val) {
      this.$router.push({ path: '/waiter/' + val})
    },
