...
public class OpOrderTypeController {
    ...
    public AjaxResult getAllType(@RequestParam(value = "searchData",required = false) String searchData){
        return ResponseTool.success(orderTypeService.selectAll(searchData));
    }
